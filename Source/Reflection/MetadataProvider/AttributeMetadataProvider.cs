	...
	public class AttributeMetadataProvider : MetadataProviderBase
	{
		...
		object[] GetMapFieldAttributes(TypeAccessor typeAccessor)
		{
			lock (_sync)
			{
				...
				return _mapFieldAttributes ?? (_mapFieldAttributes = (object[])typeAccessor.Type.GetAttributes<MapFieldAttribute>());
			}
		}
		...
		object[] GetNonUpdatableAttributes(TypeAccessor typeAccessor)
		{
			lock (_sync)
			{
				...
				return _nonUpdatableAttributes ?? (_nonUpdatableAttributes = (object[])typeAccessor.Type.GetAttributes<NonUpdatableAttribute>());
			}
		}
